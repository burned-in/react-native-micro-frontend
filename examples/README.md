...
| --- | --- | --- |
| [`general-ts`](general-ts/README.md) | General / normal TypeScript module | Metro includes a local or sibling MFE source through `withMfe`; the Host loader uses a static import map. |
...
Use `examples/mfe-feature` as the shared sample feature module for all three paths.
