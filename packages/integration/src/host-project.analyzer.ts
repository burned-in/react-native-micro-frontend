  ...
  return {
    ...
    packageManager: detectPackageManager(
      packageJson.packageManager
        ? { files, packageManagerField: packageJson.packageManager }
        : { files },
    ),
    ...
    codePushDetected: Boolean(
      dependencies['react-native-code-push'] ||
        dependencies['@microsoft/react-native-code-push'],
    ),
    typeScriptDetected:
