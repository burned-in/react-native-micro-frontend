 ...
 */
export function defineReactNativeMicroFrontendConfig(
  config: ReactNativeMicroFrontendConfig,
): ReactNativeMicroFrontendConfig {
  return config;
}
 ...
 */
export function normalizeReactNativeMicroFrontendConfig(
  userConfig: Partial<ReactNativeMicroFrontendConfig>,
): ReactNativeMicroFrontendConfig {
  return {
    reactNative: {
      ...DEFAULT_REACT_NATIVE_MICRO_FRONTEND_CONFIG.reactNative,
      ...userConfig.reactNative,
    },
    ota: {
      ...DEFAULT_REACT_NATIVE_MICRO_FRONTEND_CONFIG.ota,
      ...userConfig.ota,
    },
    nativeChangePolicy:
      userConfig.nativeChangePolicy ??
      DEFAULT_REACT_NATIVE_MICRO_FRONTEND_CONFIG.nativeChangePolicy,
    packageManager: {
      ...DEFAULT_REACT_NATIVE_MICRO_FRONTEND_CONFIG.packageManager,
      ...userConfig.packageManager,
    },
    package: {
      ...DEFAULT_REACT_NATIVE_MICRO_FRONTEND_CONFIG.package,
      ...userConfig.package,
    },
    ios: {
      ...DEFAULT_REACT_NATIVE_MICRO_FRONTEND_CONFIG.ios,
      ...userConfig.ios,
    },
    android: {
      ...DEFAULT_REACT_NATIVE_MICRO_FRONTEND_CONFIG.android,
      ...userConfig.android,
    },
