...
describe('generateHotUpdaterDeployCommand', () => {
  test('generates Hot Updater deploy commands for every supported package manager', () => {
    ...
    expect(commandFor('pnpm')).toEqual([
      'pnpm',
      'dlx',
      'hot-updater',
      'deploy',
    ...
    expect(commandFor('yarn')).toEqual([
      'yarn',
      'dlx',
      'hot-updater',
      'deploy',
    ...
    expect(commandFor('deno')).toEqual([
      'deno',
      'run',
      '-A',
      'npm:hot-updater',
  ...
  test('keeps existing deployment scripts package-manager-specific', () => {
    expect(
      generateHotUpdaterDeployCommand({
        packageManager: 'bun',
        platform: 'android',
        channel: 'staging',
