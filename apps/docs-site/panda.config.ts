...
export default defineConfig({
  preflight: true,
  include: ['./pages/**/*.{ts,tsx}', './src/**/*.{ts,tsx}'],
  exclude: [],
    ...
    extend: {
      tokens: {
        fonts: {
          body: {
            value:
              "Inter, 'Noto Sans KR', 'Noto Sans JP', 'Noto Sans SC', 'Noto Sans CJK KR', 'Noto Sans CJK JP', ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif",
          },
          mono: {
            value:
      ...
      semanticTokens: {
          ...
          surface: {
            DEFAULT: {
              value: {
                ...
                _dark: 'rgba(15,23,42,0.72)',
              },
            },
            subtle: {
              value: {
                base: 'rgba(241,245,249,0.86)',
        ...
        shadows: {
          card: {
            value: {
              base: '0 24px 80px rgba(15,23,42,0.12)',
              _dark: '0 24px 80px rgba(0,0,0,0.38)',
            },
          },
        },
      },
